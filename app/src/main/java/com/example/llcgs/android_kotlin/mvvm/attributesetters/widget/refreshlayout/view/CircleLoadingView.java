 ...
 * platforms.
 */
public class CircleLoadingView extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircleLoadingView(Context context, int color) {
        super(context);
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = CircleLoadingView.this.getWidth();
            final int viewHeight = CircleLoadingView.this.getHeight();
