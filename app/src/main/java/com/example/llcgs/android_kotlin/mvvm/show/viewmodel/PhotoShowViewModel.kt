...
class PhotoShowViewModel: BaseViewModel() {
    ...
    var url: String = "https://timgsa.baidu.com/timg?image&quality=80" +
            "&size=b9999_10000&sec=1509790203568" +
            "&di=8cbc7c7d4d9df9dc64c6d37f32be7967" +
            "&imgtype=0" +
            "&src=http%3A%2F%2Fnews.qiyue.com%2Fuploadfile%2F2016%2F0525%2F20160525104020138.jpg"
        set(value) {
            if (value.isNotEmpty()){
                field = value
                setChanged()
