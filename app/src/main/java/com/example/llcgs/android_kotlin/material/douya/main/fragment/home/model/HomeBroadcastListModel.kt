package com.example.llcgs.android_kotlin.material.douya.main.fragment.home.model
...
class HomeBroadcastListModel : BaseMaterialModel {
    ...
    fun getData(): Observable<List<com.example.llcgs.android_kotlin.material.douya.main.fragment.home.bean.BroadListContent>> {
        val array = BaseUtil.context().resources.getStringArray(R.array.databinding_nba)
        val list = ArrayList<com.example.llcgs.android_kotlin.material.douya.main.fragment.home.bean.BroadListContent>()
        var broadListContent: com.example.llcgs.android_kotlin.material.douya.main.fragment.home.bean.BroadListContent
        array.forEach {
            broadListContent = com.example.llcgs.android_kotlin.material.douya.main.fragment.home.bean.BroadListContent()
