package com.example.llcgs.android_kotlin.kotlin.other.annotation
...
// 如果需要对类的主构造函数进行标注，则需要在构造函数声明中添加constructor关键字，并将注解添加到其前面
annotation class Fop @com.example.llcgs.android_kotlin.kotlin.classandobject.classandextends.bean.Inject constructor()
...
class Example(@param:Ann(String::class, Int::class) val quux: String) {
    ...
    // 同一个目标 多个注解
    @set:[com.example.llcgs.android_kotlin.kotlin.classandobject.classandextends.bean.Inject VisibleForTesting]
    var foot = ""
