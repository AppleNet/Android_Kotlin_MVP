...
import com.example.llcgs.android_kotlin.ui.recyclerview.`interface`.SlideCallback
...
class RecyclerViewActivity: BaseActivity<RecyclerViewView, RecyclerViewPresenter>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setAdapter
        val recyclerViewAdapter = RecyclerViewAdapter(this, starList)
        recyclerView.adapter = recyclerViewAdapter
        CardConfig.initConfig(this)

        val slideCallback = SlideCallback(recyclerView, recyclerViewAdapter, starList)
