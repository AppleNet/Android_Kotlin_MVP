package com.example.llcgs.android_kotlin.architecture_components.viewmodel.model
 ...
 * @since 2017/11/30
 */
class ViewModelModel : BaseArchModel {
    ...
    fun getUrl(urlKey: String): Observable<String> = Observable.just(urlKey).map { imageUriMap[urlKey]?:"" }
}