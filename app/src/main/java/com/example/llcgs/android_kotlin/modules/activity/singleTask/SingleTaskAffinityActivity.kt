 ...
 * @since 2018/12/22
 */
class SingleTaskAffinityActivity : BaseActivity<SingleTaskView, SingleTaskPresenter>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleTv.text = "SingleTaskAffinityActivity"
        button34.setOnClickListener {
            startActivity(Intent(this, SingleTaskAffinity1Activity::class.java))
        }
    }
}
