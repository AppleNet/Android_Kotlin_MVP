...
class Utils {
    ...
    static void applyMapping(Task proguardTask, File mappingFile) {
    ...
    static String hex(byte[] byteCode) {
        try {
    ...
    static Map<String, String> readHex(File hexFile) {
    ...
    static void writeHex(Map<String, String> hexs, File hexFile) {
        try {
