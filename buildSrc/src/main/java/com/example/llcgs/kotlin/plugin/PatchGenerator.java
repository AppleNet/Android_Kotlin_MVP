...
class PatchGenerator {
    ...
    PatchGenerator(Project project, File patchFile, File jarFile,
                   File hexFile) {
    ...
    void checkClass(String className, String hex, byte[] byteCode) {
    ...
    void generate() throws Exception {
        ...
        project.exec(new Action<ExecSpec>() {
            @Override
            public void execute(@NotNull ExecSpec execSpec) {
